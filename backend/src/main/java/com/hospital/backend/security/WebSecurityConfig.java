...
import com.hospital.backend.security.jwt.AuthEntryPointJwt;
import com.hospital.backend.security.jwt.AuthTokenFilter;
import com.hospital.backend.security.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000",
                "http://localhost:3001",
                "hospital-management-three-hazel.vercel.app"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/", "/index.html", "/error").permitAll()
